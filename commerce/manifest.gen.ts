...
import * as $$$4 from "./loaders/product/extensions/suggestions.ts";
import * as $$$5 from "./loaders/product/productListingPage.ts";
...
const manifest = {
  "loaders": {
    ...
    "commerce/loaders/product/extensions/suggestions.ts": $$$4,
    "commerce/loaders/product/productListingPage.ts": $$$5,
